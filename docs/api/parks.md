---
layout: default
title: /parks Resource
description: The /parks resource stores information about state and national parks in California.
---
...
* [GET parks](parks-get-parks)
* [GET parks by ID](parks-get-parks-by-id)
* [POST parks](parks-post-parks)
* [PUT parks by ID](parks-put-parks-by-id)
* [PATCH parks by ID](parks-patch-parks-by-id)
* [DELETE parks by ID](parks-delete-parks-by-id)

# Other Resources

Also, see [`/visitors`](visitors) resource.

---
layout: default
title: Touch Grass API overview
description: The Touch Grass service is a REST API that provides information about state and national parks in California. It also collects common interests among types of visitors for comparison with parks with similar traits.
---
